...
- **Issue sources**: Prefer canonical flat `issue_file` paths `.scratch/<feature>/issues/<NN-slug>.md`; also accept legacy `.scratch/<feature>/issues/<NN-slug>/` paths and GitHub issue numbers
...
- `<issue_file>` at `.scratch/<feature>/issues/<NN-slug>.md` — canonical contract and background
